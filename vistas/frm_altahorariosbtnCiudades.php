					...
					<div class="panel-body" id="cuerpoform" style="margin-bottom: 35px;">
			    		<div class="row">
   							<div class="col-xs-9 col-sm-9 col-md-9">
    							<div class="form-group"><br><label style="font-weight: bold;">Seleccione la Ciudad</label>
    									...
    									<tr>
    										<td>
    											<div class='col2' style='text-decoration: none;  color: none; margin-top: 15px;color: black;border: solid 1px #e1e3e6;width: 200%; background: #fbcf4c;background-image: -webkit-linear-gradient(top, #fbcf4c 0%, #deb22f 100%)'>
    												<a href='frm_altahorariosbtnSucursales.php?ciudad=$ciudad' class='btn btnEnviar btnVerCartelera' style='font-weight: bold; color: black; font-size: 14px; width: 100%;'>$ciudad</a>
    											</div>
    										</td>
    									</tr>
    										";
