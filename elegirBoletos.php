...
<script>(function (w, d, s, l, i) {
    ...
    Cinepolis Online
        ...
        <link href="visStyles.css" type="text/css" rel="stylesheet" /><link href="visStylesUser.css?V2" type="text/css" rel="stylesheet" /><link href="css/compra-asientos.css?v4" rel="stylesheet" />
    ...
    <div class="FormStandard" onload="window.history.go(1);">
        ...
        <SCRIPT type="text/javascript" src="pase/swfobject.js"></SCRIPT>
        <SCRIPT type="text/javascript" src="pase/jsapi.js"></SCRIPT>
        <SCRIPT type="text/javascript" charset="utf-8">    google.load("jquery", "1.3");</SCRIPT>
        <LINK title="prettyPhoto main stylesheet" rel="stylesheet" type="text/css" href="pase/estilos-Pase.css" 
        charset="utf-8" media="screen">
        <SCRIPT type="text/javascript" charset="utf-8" src="pase/jquery-Pase.js"></SCRIPT>
        <form name="frmSelectTickets" method="post" action="visSelectTickets.aspx?tkn=&amp;cinemacode=149&amp;txtSessionId=209331&amp;distributor=Disney&amp;originalTitle=The+Nutcracker+and+the+Four+Realms+(USA%2c+2018)&amp;language=&amp;genre=Fantasia&amp;rating=A&amp;director=Lasse+Hallstr%u00f6m&amp;protagonist=Morgan+Freeman%2cHelen+Mirren%2cEugenio+Derbez%2cKeira+Knightley%2cMackenzie+Foy&amp;_ga=2.68479313.1528445947.1541251178-1564106551.1538674766" id="frmSelectTickets">
...
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
            
<head>
    <meta charset="UTF-8">
    <!-- <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/> -->
    <title>Cin&eacute;polis</title>
    ...
    <link href="csscompra/reset.css" rel="stylesheet" />
    <link href="csscompra/master.css" rel="stylesheet" />
    <link href="csscompra/compra.css" rel="stylesheet" />      
    <link href="csscompra/responsive-compra.css" rel="stylesheet" />
    <link href="csscompra/responsive-master.css" rel="stylesheet" />
    <link href="csscompra/visStylesUser.css" rel="stylesheet" />
    <!--[if lt IE 9]>
...
include ('headercompraboleto/encabezadoMod.php');
...
<div class="wrapper">
    ...
    <script type="text/javascript" language="javascript" src="top.js?v=1"></script>
...
<p class="compraTotal"><span id="visOrderTracker_txtTicketSubtotalDetails"></span> </p>
...
Agradeceremos se consulte la política de precios en el cine de tu preferencia.  <BR></span></div>
     

            <div class="col3">
                <p class="txtCompra">SUBTOTAL:</p>
                <p class="compraTotal">
                    <span id="spTotalCompra">
                        $0.00
                    </span>
                ...
                <p class="text-center">
                    <input type="image" name="ibtnChangeSession" id="ibtnChangeSession" class="ImageChangeSession" src="Imagenes/changesession.gif" border="0" /> 
                </p>
            </div>
                ...
                <table class="BodyTable" id="tblBody" cellSpacing="0" cellPadding="0" border="0">
                    <tr>
                        <td>
                          ...
                          <center> </center> 
                            <span id="spanCartelExtra" CssClass="TicketPageText" style="display:none"></span>
                            ...
                            <center> <img src="images/cintillo-Marvel.jpg" id="imfSuperTicketMarvel" style="display:none" /></center>
    ...
    <th><span id="lblTicketSubtotal" class="TicketTypeHeader">SUBTOTAL:</span></th>
                                        ...
                                        <td colspan="4" style="text-align:left">
                                            ...
                                            <td></td>
                                               ...
                                               <td class="TicketTypeCell desc1"><span id="rptAreaCategory__ctl0_rptTicketList__ctl1_lblDescription0" class="TicketType">ADULTO</span><span id="rptAreaCategory__ctl0_rptTicketList__ctl1_lblLongDescription0" class="TicketTypeSubText"></span></td>
                                               <td valign="top" align="right" class="TicketQtyCell"><span class="desc2">ADULTO</span>

                                                <div class="spinner">

                                                <button type="button" class="decrease" disabled="disabled" onclick="decrementaradulto();" name="botondecrementaradulto" id="botondecrementaradulto">-</button>

                                                <input name="totalboletosadultos" type="text" readonly="readonly" id="totalboletosadultos" maxlength="2" value="0">

                                                <button type="button" class="increase" onclick="incrementaradulto();" name="botonincrementaradulto" id="botonincrementaradulto">+</button>

                                                </div>


                                            <div class="selector" id="uniform-rptAreaCategory__ctl0_rptTicketList__ctl1_ddlQty0" style="width: 96px;"><span style="width: 84px; user-select: ;">0</span>

                                                <select name="rptAreaCategory:_ctl0:rptTicketList:_ctl1:ddlQty0" id="rptAreaCategory__ctl0_rptTicketList__ctl1_ddlQty0" class="TicketTypeDropDown" loyaltyreward="0" barcode="" price="12700" ticketlabel="ADULTO" loyalty="0" tickettypehocode="1" ticketlabelalt="" loyaltyrecognitionid="" areacategorysequence="1" availabletomembercard="N" mmcprovidername="" isseatallocationon="Y" membershipticket="0" identity="0002" onchange="CalculateTotals(this.form.rptAreaCategory__ctl0_rptTicketList__ctl1_ddlQty0.value,2,12700,document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl1_TicketSubTotal0'),'$#','.','rptAreaCategory__ctl0_rptTicketList__ctl1_TotalInCents0','visSelectTickets');CalculatePoints(this.form.0,-1,'+<AMOUNT> Points',2,'.',document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl1_LtyPointsCostSubTotal0'),'rptAreaCategory__ctl0_rptTicketList__ctl1_TotalInPoints0');" availforltydiscount="N" style="width: 50px;">
    ...
    <option value="10">10</option>
                                                ...
                                                $Tprecio = pg_query("select altasucursal.nombre, precioboletos.adultoprimerrango from altasucursal INNER JOIN precioboletos ON altasucursal.nombre = precioboletos.nombrecine;");

                                                while ($datos=pg_fetch_array($Tprecio)) {
                                                    
                                                    $precio = $datos['adultoprimerrango'];
  
                                            echo "
                                               <td valign='top' class='Price'><span id='rptAreaCategory__ctl0_rptTicketList__ctl1_TicketPrice0' class='TicketTypePrice'>$$precio</span><input name='rptAreaCategory:_ctl0:rptTicketList:_ctl1:TotalInPoints0' type='hidden' id='rptAreaCategory__ctl0_rptTicketList__ctl1_TotalInPoints0' value='0'></td>    
                                               <td valign='top' class='Price'><span id='rptAreaCategory__ctl0_rptTicketList__ctl1_TicketSubTotal0' class='TicketTypeSubTotal'>$0.00</span>
                                            ";
                                        }
                                        ?>
                                                <input name="rptAreaCategory:_ctl0:rptTicketList:_ctl1:TotalInCents0" type="hidden" id="rptAreaCategory__ctl0_rptTicketList__ctl1_TotalInCents0" value="0"></td>
                                                        
                                              </tr>
                                          
                                             <tr class="TicketTypeRow" ticketclass="NormalTicketTypeRow" areacategory="">
                                              <td>     </td>
                                                <td class="TicketTypeCell desc1"><span id="rptAreaCategory__ctl0_rptTicketList__ctl2_lblDescription1" class="TicketType">3 ERA EDAD</span><span id="rptAreaCategory__ctl0_rptTicketList__ctl2_lblLongDescription1" class="TicketTypeSubText"></span></td>

                                                <td class="TicketQtyCell"><span class="desc2">3 ERA EDAD</span><div class="spinner"><button type="button" class="decrease" disabled="disabled" onclick="decrementartercera();" name="botondecrementartercera" id="botondecrementartercera">-</button>

                                                    <input name="totalboletostercera" type="text" readonly="readonly" id="totalboletostercera" maxlength="2" value="0">

                                                    <button type="button" class="increase" onclick="incrementartercera();" name="botonincrementartercera" id="botonincrementartercera">+</button>

                                                </div><div class="selector" id="uniform-rptAreaCategory__ctl0_rptTicketList__ctl2_ddlQty1" style="width: 96px;"><span style="width: 84px; user-select: none;">0</span><select name="rptAreaCategory:_ctl0:rptTicketList:_ctl2:ddlQty1" id="rptAreaCategory__ctl0_rptTicketList__ctl2_ddlQty1" class="TicketTypeDropDown" loyaltyreward="0" barcode="" price="10000" ticketlabel="3 ERA EDAD" loyalty="0" tickettypehocode="3" ticketlabelalt="" loyaltyrecognitionid="" areacategorysequence="1" availabletomembercard="N" mmcprovidername="" isseatallocationon="Y" membershipticket="0" identity="0004" onchange="CalculateTotals(this.form.rptAreaCategory__ctl0_rptTicketList__ctl2_ddlQty1.value,2,10000,document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl2_TicketSubTotal1'),'$#','.','rptAreaCategory__ctl0_rptTicketList__ctl2_TotalInCents1','visSelectTickets');CalculatePoints(this.form.rptAreaCategory__ctl0_rptTicketList__ctl2_ddlQty1.value,-1,'+<AMOUNT> Points',2,'.',document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl2_LtyPointsCostSubTotal1'),'rptAreaCategory__ctl0_rptTicketList__ctl2_TotalInPoints1');" availforltydiscount="N" style="width: 50px;">
    <option selected="selected" value="0">0</option>
    <option value="1">1</option>
    <option value="2">2</option>
    <option value="3">3</option>
    ...
    <option value="10">10</option>
                                                ...
                                                <td class="Price"><span id="rptAreaCategory__ctl0_rptTicketList__ctl2_TicketPrice1" class="TicketTypePrice">$100.00</span><input name="rptAreaCategory:_ctl0:rptTicketList:_ctl2:TotalInPoints1" type="hidden" id="rptAreaCategory__ctl0_rptTicketList__ctl2_TotalInPoints1" value="0"></td>
                                                        
                                                <td class="Price"><span id="rptAreaCategory__ctl0_rptTicketList__ctl2_TicketSubTotal1" class="TicketTypeSubTotal">$0.00</span><input name="rptAreaCategory:_ctl0:rptTicketList:_ctl2:TotalInCents1" type="hidden" id="rptAreaCategory__ctl0_rptTicketList__ctl2_TotalInCents1" value="0"></td>
                                                <td></td>
                                              </tr>
                                            ...
                                            <td>     </td>
                                               ...
                                               <td valign="top" align="right" class="TicketQtyCell"><span class="desc2">NIÑOS</span>
                                                

                                                <div class="spinner">
                                                    <button type="button" class="decrease" disabled="disabled" onclick="decrementarninos();" name="botondecrementarninos" id="botondecrementarninos">-</button>

                                                    <input name="totalboletosninos" type="text" readonly="readonly" id="totalboletosninos" class="" maxlength="2" value="0">

                                                        <button type="button" class="increase"  onclick="incrementarninos();" name="botonincrementarninos" id="botonincrementarninos">+</button></div>


                                                        <div class="selector" id="uniform-rptAreaCategory__ctl0_rptTicketList__ctl3_ddlQty2" style="width: 96px;"><span style="width: 84px; user-select: none;">0</span>



                                                        <select name="rptAreaCategory:_ctl0:rptTicketList:_ctl3:ddlQty2" id="rptAreaCategory__ctl0_rptTicketList__ctl3_ddlQty2" class="TicketTypeDropDown" loyaltyreward="0" barcode="" price="10000" ticketlabel="NIÑOS" loyalty="0" tickettypehocode="2" ticketlabelalt="" loyaltyrecognitionid="" areacategorysequence="1" availabletomembercard="N" mmcprovidername="" isseatallocationon="Y" membershipticket="0" identity="0003" onchange="CalculateTotals(this.form.rptAreaCategory__ctl0_rptTicketList__ctl3_ddlQty2.value,2,10000,document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl3_TicketSubTotal2'),'$#','.','rptAreaCategory__ctl0_rptTicketList__ctl3_TotalInCents2','visSelectTickets');CalculatePoints(this.form.rptAreaCategory__ctl0_rptTicketList__ctl3_ddlQty2.value,-1,'+<AMOUNT> Points',2,'.',document.getElementById('rptAreaCategory__ctl0_rptTicketList__ctl3_LtyPointsCostSubTotal2'),'rptAreaCategory__ctl0_rptTicketList__ctl3_TotalInPoints2');" availforltydiscount="N" style="width: 50px;">
    <option selected="selected" value="0">0</option>
    <option value="1">1</option>
    <option value="2">2</option>
    <option value="3">3</option>
    ...
    <option value="10">10</option>
                                               ...
                                               <td valign="top" class="Price"><span id="rptAreaCategory__ctl0_rptTicketList__ctl3_TicketPrice2" class="TicketTypePrice">$100.00</span><input name="rptAreaCategory:_ctl0:rptTicketList:_ctl3:TotalInPoints2" type="hidden" id="rptAreaCategory__ctl0_rptTicketList__ctl3_TotalInPoints2" value="0"></td>    
                                               <td valign="top" class="Price"><span id="rptAreaCategory__ctl0_rptTicketList__ctl3_TicketSubTotal2" class="TicketTypeSubTotal">$0.00</span><input name="rptAreaCategory:_ctl0:rptTicketList:_ctl3:TotalInCents2" type="hidden" id="rptAreaCategory__ctl0_rptTicketList__ctl3_TotalInCents2" value="0"></td>
                                      ...
                                      <center> <img src="images/SLIDER-GENERICO.jpg" id="imgImagenExtraPelicula" style="display:none"></center>
                           <div id="pnlVOUCHER"> 
...
<table id="tblVoucherEntry" width="570px" cellpadding="0" cellspacing="0" class="VoucherRow" style="display:none">
        <tr id="RowVoucherEntry">
            <td><a href="#"><img src="Images/PackageTicket.gif" id="btnShowContents" class="ImageBtnPackageTicket" border="0" OnClick="ShowContents('1','','','visvoucherentry','voucherentry');" /></a></td>
            <td><span id="lblVoucherEntry" class="VoucherEntryText">INGRESE EL CODIGO DE SU CUPON:</span></td>
            <td></td>
        </tr>
    ...
    <div class="ingreso-folio">
        ...
        <div class="row">
            ...
            <div class="mas-info-folios">
                <a href="#" class="cerrar-mas-info" onclick="javascript:$(this).parent().fadeOut(); return false;">
                ...
                <p>
                    ...
                    Es necesario ingresar el folio uno por uno y las veces deseadas para obtener la cantidad de boletos. Para aplicar promoción 2x1 será necesario ingresar los dos folios por separado.
                                    ...
                                    <div id="divOrderTickets" class="Inline">
                                    	<?php
                                    	...
                                    	$totalboletos = 2;
                                    	 ...
                                    	 echo "<a href='escoge-tu-lugar.php?id_horario=$idhorario&cantidad_boletos=$totalboletos'/><img src='img/vistaCliente/iconos/nextSeat.gif' border='0'></a>";?>
                                    ...
                                    <div id="divSelectConcessions" class="Inline" style="display:none; VISIBILITY: hidden"><input type="image" name="ibtnSelectConcessions" id="ibtnSelectConcessions" class="ImageSelectConcessions" src="Images/selectconcessions.gif" border="0" onclick="document.frmSelectTickets.txtDoNotRehydrate.value = 'Yes';document.frmSelectTickets.txtHideAllVoucherRows.value = 'No';DisableButtons(this, 'btnSelectConcessionsClick');HideShowLayer('ProcAnimation');__doPostBack('ibtnSelectConcessions','');" language="javascript" /></div>
...
<fieldset>
    <div class="paseCinepass">
        ...
        <div class="tooltip" style="display: none; right: 10px;">
            <iframe id="fraCINEPASS" height="360" width="390" src="">
            </iframe>
        </div>
    </div>
</fieldset>
<a href="./visCINEPASS.aspx?cinemacode=149&txtSessionId=209331&CiudadID=&id=1?iframe=true" id="lnkCINEPASS" name="lnkCINEPASS">
</a>
...
<fieldset>
    <div class="paseAnual">
        ...
        <div class="tooltip" style="display: none; right: 10px;">
            <iframe id="fraPASE" height="260" width="390" src="">
            </iframe>
        </div>
    </div>
</fieldset>
<a href="visPase.aspx?cinemacode=149&txtSessionId=209331&CiudadID=&id=1?iframe=true" id="lnkPase" name="lnkPase"></a>
...
<div id="MSGLightBox" class="sjmodal-container" style="display: none;">
    <a href="#" class="sjmodal-close" onclick="fnLightBoxSalir();"></a>
...
<button class="mbtn" style="display:none">Ok, Entendido </button></p>

</div> 
 
    <link href="css/estilos-modal-cinepolis.css?V3=4" type="text/css" rel="stylesheet" />
...
document.getElementsByTagName('head')[0].appendChild(ta);
 ...
 <input name="hdVF" type="hidden" id="hdVF" />
        <input name="txtIP" type="hidden" id="txtIP" />
        <script language="JavaScript" src="https://co.cineticket-la.com/compra/ip.js.asp"></script>
        <script language="JavaScript">
            ...
            <tr>
            <td width="695" height="12" Class="FinCartelera">
                    &nbsp;
...
<script language='javascript'>CalcOrderTotal('2','$#','.','visSelectTickets');CalcOrderPoints('+<AMOUNT> Points',2,'.');</script><script language='javascript'>HideLayer('divSignIn');</script><script language='javascript'>try {setDescriptionCss('rptAreaCategory__ctl0_rptTicketList__ctl1_lblDescription0','0','False');} catch (e) {}</script><script language='javascript'>try {setDescriptionCss('rptAreaCategory__ctl0_rptTicketList__ctl2_lblDescription1','0','False');} catch (e) {}</script><script language='javascript'>try {setDescriptionCss('rptAreaCategory__ctl0_rptTicketList__ctl3_lblDescription2','0','False');} catch (e) {}</script><script language='javascript'>document.getElementById('tickets').style.display = 'none';document.getElementById('cart').style.display = 'none';</script></form>
    ...
    var getUrlParameter = function getUrlParameter(sParam) {
        ...
        <div id="testDIV"><max_boletos_04></div>
    ...
    document.getElementById('ColSubTotal').style.display='none' ;
            ...
            function incrementaradulto() {
                            valor = parseInt(document.getElementById('totalboletosadultos').value);
                            ...
                            if(suma >= 0 && suma <=9){
                                ...
                                $("#totalboletosadultos").attr("value",suma);
                                $('#botondecrementaradulto').removeAttr('disabled');

                            }
                            else{
                                $('#botonincrementaradulto').attr('disabled','disabled');
                            }
            ...
            function decrementaradulto() {
                   valor = parseInt(document.getElementById('totalboletosadultos').value);
                   var resta = valor;

                   if(resta > 0){
                   resta = resta - 1;
                   $("#totalboletosadultos").attr("value",resta);
                $('#botonincrementaradulto').removeAttr('disabled');
               }
               else
               {
                $('#botondecrementaradulto').attr('disabled','disabled');
                $('#botonincrementaradulto').removeAttr('disabled');
               }
            }

            function incrementartercera() {
                            valor = parseInt(document.getElementById('totalboletostercera').value);
                            ...
                            if(suma >= 0 && suma <=9){
                                ...
                                $("#totalboletostercera").attr("value",suma);
                                $('#botondecrementartercera').removeAttr('disabled');

                            }
                            else{
                                $('#botonincrementartercera').attr('disabled','disabled');
                            }
            ...
            function decrementartercera() {
                   valor = parseInt(document.getElementById('totalboletostercera').value);
                   var resta = valor;

                   if(resta > 0){
                   resta = resta - 1;
                   $("#totalboletostercera").attr("value",resta);
                $('#botonincrementartercera').removeAttr('disabled');
               }
               else
               {
                $('#botondecrementartercera').attr('disabled','disabled');
                $('#botonincrementartercera').removeAttr('disabled');
               }
            }

            function incrementarninos() {
                            valor = parseInt(document.getElementById('totalboletosninos').value);
                            ...
                            if(suma >= 0 && suma <=9){
                                ...
                                $("#totalboletosninos").attr("value",suma);
                                $('#botondecrementarninos').removeAttr('disabled');

                            }
                            else{
                                $('#botonincrementarninos').attr('disabled','disabled');
                            }
            ...
            function decrementarninos() {
                   valor = parseInt(document.getElementById('totalboletosninos').value);
                   var resta = valor;

                   if(resta > 0){
                   resta = resta - 1;
                   $("#totalboletosninos").attr("value",resta);
                $('#botonincrementartercera').removeAttr('disabled');
               }
               else
               {
