...
if(!isset($_SESSION['id_cinepolisid'])) 
{
  header('Location: ../index.php');
	...
	$PrecioTotal = 0;$nombreciudadHeader = "";$nombresucursalHeader = "";$_SESSION['asientos3raedad'] = "";$_SESSION['asientosAdultos']="";$_SESSION['asientosNinos']="";$asientosseleccionados3raedad = "";$asientosseleccionadosadultos = "";$asientosseleccionadosniños = "";

	include ('../bd/conexion.php'); $conexion = conectarBD(); 

	$id_cinepolisid = $_SESSION['id_cinepolisid'];
	$nombre = $_SESSION['nombreUsuarioLogeado'];
...
<FORM method="post" action="../index.php" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
	...
	<div id="wrapper" class="wrapper" style="left: 0%;">
		...
		<!--CINEPOLISID-->
		<?php include('headerCinepolisID/encabezado.php'); ?>
		<section class="panel" id="conectado">
			<div class="row">
				<?php include('contenido/perfil.php'); ?>
				<?php include('contenido/recomendaciones.php'); ?>
				<?php include('contenido/navegacionMenu.php'); ?>
				<?php include('contenido/seccionesCinecash.php'); ?>
			</div>
		</section>
		...
		<!--CONTENIDO YA DEFINIDO Y TOMADO DEL CLIENTE SIN CINEOPLISID-->
		<!--PREDEFINIDOS-->
		...
		<?php include('footerCinepolisID/footer.php'); ?>
	</div> <!--FIN wrapper-->
</FORM> <!--FIN FORMULARIO(unico)-->
<!--<script src="../../js/vistaCliente/modernizr.js"></script>-->
